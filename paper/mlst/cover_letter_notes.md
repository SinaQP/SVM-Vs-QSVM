...
- Perform the final author read-through of both PDFs, verify that historical release `v1.0.0` remains accessible, and verify the published archival release [`v1.1.0`](https://github.com/SinaQP/SVM-Vs-QSVM/releases/tag/v1.1.0) before submission.
