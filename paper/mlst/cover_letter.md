...
**Date:** September 2026
**Subject:** Benchmark — *A Controlled Empirical Comparison of Classical and Quantum Kernel SVMs for Breast Cancer Classification*

Dear Editors,

Please consider the manuscript **“A Controlled Empirical Comparison of Classical and Quantum Kernel SVMs for Breast Cancer Classification”** for publication as a Benchmark article in *Machine Learning: Science and Technology*. Benchmark is the intended submission type based on the journal's current definition of comparative evaluations on a consistent problem or dataset, subject to editorial and submission-portal classification.
...
The public repository is available at [https://github.com/SinaQP/SVM-Vs-QSVM](https://github.com/SinaQP/SVM-Vs-QSVM). The published submission-associated archival release is `v1.1.0` ([https://github.com/SinaQP/SVM-Vs-QSVM/releases/tag/v1.1.0](https://github.com/SinaQP/SVM-Vs-QSVM/releases/tag/v1.1.0)); it contains the corrected nested methodology, authoritative outputs, configurations, predictions, and validation scripts supporting this submission. Historical release `v1.0.0` remains preserved for provenance. The manuscript and supplementary material identify the benchmark as non-clinical and distinguish exact statevector simulation from physical QPU execution.

This research received no external funding. I declare no conflict of interest. The study used a publicly available benchmark dataset and did not recruit human participants or collect new clinical data. I confirm that this manuscript is original, is not under consideration for publication elsewhere, and that I approve the submitted final version.
