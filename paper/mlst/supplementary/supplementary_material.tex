...
QSVC (2Q Statevector) & Vectorized CPU & 2 & $0.2257 \pm 0.0232$ & $\sim 47\times$ & $\mathcal{O}((N_{tr}^2+N_{te}N_{tr})2^q)$ plus SVC & Train+test kernels: 2,071,160 B \\
QSVC (4Q Statevector) & Vectorized CPU & 4 & $0.6599 \pm 0.0863$ & $\sim 80\times$ & Same form with larger $q$ plus SVC & Train+test kernels: 2,071,160 B \\
\midrule
