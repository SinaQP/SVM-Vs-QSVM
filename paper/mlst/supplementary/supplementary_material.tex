...
\noindent\textbf{Provenance:} historical release \texttt{v1.0.0}; corrected submission-associated archival release \texttt{v1.1.0}\\
\noindent\textbf{Release:} \url{https://github.com/SinaQP/SVM-Vs-QSVM/releases/tag/v1.1.0}\\
